...
Regarding the threshold $\tau_1, \tau_2, \tau_3$ values, they are initiated to keep a significant number of patches (higher than 10) and are afterwards refined by increasing step
